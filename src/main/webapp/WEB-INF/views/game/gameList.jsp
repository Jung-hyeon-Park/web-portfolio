	...
	<div style="float: center; margin-top: 30px;">
		<div class="btn-group btn-group-toggle" data-toggle="buttons">
			<c:forEach var="console2VO" items="${console2VOs}">
  				<label class="btn btn-secondary <c:if test="${console2VO.category2Idx eq ct2Idx}">active</c:if>" style="width: 90px;">
    				<input type="radio" name="console2" id="option1" autocomplete="off" value="${console2VO.category2Idx}" />${console2VO.name2}
  				</label>
			</c:forEach>
		</div>
	</div>
		...
		<div class="btn-group btn-group-toggle" data-toggle="buttons">
			<c:forEach var="console3VO" items="${console3VOs}">
  				<label class="btn btn-secondary" style="width: 90px;">
    				<input type="radio" name="console3" id="option1" autocomplete="off" value="${console3VO.category3Idx}" checked />${console3VO.name3}
  				</label>
			</c:forEach>
		</div>
	</div>
